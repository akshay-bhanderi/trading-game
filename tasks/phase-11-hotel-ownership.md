...
Status: **✅ Complete (T053–T058).** Built ahead of T045 per explicit user direction (testing/harness gates deferred to T068; see project memory) — functionality verified by inspection + `tsc -b`/`vite build`, not by dedicated tests.
...
- [x] **T053 — Hotel config & data (tier costs/revenue/license off city nightly rate)**
...
- [x] **T054 — Hotel build/upgrade engine (marginal cost stacking)**
...
- [x] **T055 — Hotel passive revenue accrual + free stays for owner**
...
- [x] **T056 — Hotel epidemic-pause interaction**
...
- [x] **T057 — Hotel annual license fee billing + sell-back**
...
- [x] **T058 — UI Screen 10: Real Estate/Hotels screen + City-screen "buy hotel here" button**
