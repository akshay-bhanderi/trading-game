...
/** The 11 base event types from §7's table, plus Phase 2 additions.
 * "Warehouse fire" (§14) is added by T050, elsewhere. "Aviation safety
 * incident" (§16, T065) is added here: it grounds one random leased plane
 * for 5-10 days rather than moving any commodity price — see
